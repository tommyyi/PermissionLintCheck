 ...
 */
public class DetectorSDCard extends Detector implements Detector.JavaScanner
{
    public static Issue ISSUE_SDCARD = Issue.create("access SDCard",
        "sdcard operation should be done after WRITE_EXTERNAL_STORAGE permission check",
        "sdcard operation should be done after WRITE_EXTERNAL_STORAGE permission check, you should declare WRITE_EXTERNAL_STORAGE in manifest at the same time",
        /**
         ...
         */
        new Implementation(DetectorSDCard.class, Scope.JAVA_FILE_SCOPE));
    
    public static final String[] sSupportSuperType = new String[] {"android.os.Environment"};
    ...
    public List<String> getApplicableMethodNames()
    {
        ...
        methodList.add("getExternalStorageDirectory");
        return methodList;
    }
    ...
    public void visitMethod(JavaContext context, AstVisitor visitor, MethodInvocation node)
    {
        ...
        if (!isSubClass)
            ...
            context.report(ISSUE_SDCARD, node, context.getLocation(node), "please check permission WRITE_EXTERNAL_STORAGE");
    }
}
